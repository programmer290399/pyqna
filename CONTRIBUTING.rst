...
pyqna could always use more documentation, whether
as part of the official pyqna docs, in docstrings,
...
1. Fork the `pyqna` repo on GitHub.
...
3. The pull request should work for Python 2.7, 3.3, 3.4, 3.5 and for PyPy. Check
   https://travis-ci.org/programmer290399/pyqna/pull_requests
